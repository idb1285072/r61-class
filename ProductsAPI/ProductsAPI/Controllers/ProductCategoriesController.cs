...
namespace ProductsAPI.Controllers
{
    ...
    public class ProductCategoriesController : ControllerBase
    {
        ...
        {
            return await _context.ProductCategory.Include(pc => pc.Products).OrderByDescending(p=>p.ProductCategoryID).ToListAsync();
        }
        ...
        public async Task<IActionResult> PutProductCategory(int id, ProductCategory productCategory)
        {
            ...
            var exist = _context.ProductCategory.Find(id);
            exist.Name = productCategory.Name;
            exist.ProductCategoryID = productCategory.ProductCategoryID;
            exist.Products = productCategory.Products;
