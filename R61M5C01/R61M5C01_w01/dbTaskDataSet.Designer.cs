...
namespace R61M5C01_w01.dbTaskDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ((@IsNull_EmployeeN" +
                "ame = 1 AND [EmployeeName] IS NULL) OR ([EmployeeName] = @Original_EmployeeName)" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([EmployeeName]) VALUES (@EmployeeName);\r\nSELECT Id," +
                " EmployeeName FROM Employee WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employee] SET [EmployeeName] = @EmployeeName WHERE (([Id] = @Origin" +
                "al_Id) AND ((@IsNull_EmployeeName = 1 AND [EmployeeName] IS NULL) OR ([EmployeeN" +
                "ame] = @Original_EmployeeName)));\r\nSELECT Id, EmployeeName FROM Employee WHERE (" +
                "Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::R61M5C01_w01.Properties.Settings.Default.dbTaskConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, EmployeeName FROM dbo.Employee";
        ...
        public virtual int Fill(dbTaskDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual dbTaskDataSet.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbTaskDataSet.EmployeeDataTable dataTable = new dbTaskDataSet.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbTaskDataSet.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_EmployeeName) {
        ...
        public virtual int Update(string EmployeeName, int Original_Id, string Original_EmployeeName, int Id) {
            if ((EmployeeName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string EmployeeName, int Original_Id, string Original_EmployeeName) {
            return this.Update(EmployeeName, Original_Id, Original_EmployeeName, Original_Id);
        }
    }
