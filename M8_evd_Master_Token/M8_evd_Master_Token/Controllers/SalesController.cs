...
using M8_evd_Master_Token.DTO;
using M8_evd_Master_Token.Models;
using Newtonsoft.Json;

namespace M8_evd_Master_Token.Controllers
{
    [Authorize]
    public class SalesController : ApiController
    {
        ...
        {
            //var model= dbInvContext.Details.Include("Product")
            //                            .Include("Sales")
            //                            .ToList();
        ...
        {
            //return dbInvContext.Sales.Find(id);
