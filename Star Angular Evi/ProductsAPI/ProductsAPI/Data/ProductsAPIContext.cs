...
namespace ProductsAPI.Data
{
    public class ProductsAPIContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer(@"Server=(localdb)\MSSQLLocalDB;Database=ProductsDBContext;Trusted_Connection=True");
